...
@section('content')
    <div class="card shadow-lg mt-3">
        <div class="card-header ribbon ribbon-end ribbon-clip">
            <div class="card-toolbar">
                ...
                <div class="d-flex align-items-center border-radius">
                    <form action="/proveedores/list" method="post" autocomplete="off" class="d-flex align-items-center">
                        @csrf
                        @method('POST')
        ...
        <div class="card-footer">
            {{ $proveedores->appends(['filtro' => $filtro])->links('vendor.pagination.bootstrap-5') }}
        </div>
    </div>

    <form method="post" id="deleteForm" action="/proveedores/delete">
        @csrf
        @method('DELETE')
