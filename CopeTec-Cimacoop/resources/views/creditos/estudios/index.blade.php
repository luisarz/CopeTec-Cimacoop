...
<div class="card shadow-lg">
    <div class="card-header ribbon ribbon-end ribbon-clip">
        <div class="d-flex align-items-center">
            <form action="/creditos/solicitudes/estudios" method="post" autocomplete="off" class="d-flex align-items-center">
                {!! csrf_field() !!}
                {{ method_field('POST') }}
                <!--begin::Input group-->
            ...
            <table class="table table-hover  table-row-dashed fs-5     gy-2 gs-5">
                ...
                <tbody>
                    @foreach ($creditos as $credito)
                        <tr>
                            <td>
                                <a href="/creditos/preaprobado/liquidar/{{$credito->id_credito}}" class="btn btn-danger btn-sm w-30">
