        ...
        <div class="w-lg-50">
            ...
            <div class="d-flex flex-column text-center">
                <div class="d-flex align-items-start justify-content-center mb-7">
                    ...
                    <span class="fw-bold fs-3x" id="kt_modal_create_campaign_budget_label">{{number_format($TOTAL_PAGAR,2)}}</span>
                </div>
        ...
        <form action="/creditos/payment" method="post">
            ...
            <div class="form-group row mb-5">
                <div class="form-floating col-lg-6">
                    <input type="number" step="any" min="{{$TOTAL_PAGAR}}" value="{{$TOTAL_PAGAR}}" name="monto_saldo" id="monto_saldo" class="form-control" placeholder="Monto Abonar">
