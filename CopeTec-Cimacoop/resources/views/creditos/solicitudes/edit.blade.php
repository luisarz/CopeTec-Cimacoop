...
@section('content')
    ...
    <form action="/creditos/solicitudes/put" method="post" autocomplete="off">
        {!! csrf_field() !!}
        {{ method_field('PUT') }}
                    ...
                    <div class="tab-pane fade show active" id="tabSolicitante" role="tabpanel">
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating col-lg-2">
                                <input type="date" value="{{ $solicitud->fecha_solicitud }}" required  
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating  col-lg-3">
                                <input type="text" value="{{ $cliente->dui_cliente }}" required class="form-control"
                                    placeholder="Dui Cliente" name="dui_cliente" id="dui_cliente"   />
                                <label>Dui:</label>
                            </div>

                            <div class="form-floating  col-lg-4">
                                <input type="date" value="{{ $cliente->fecha_expedicion }}" class="form-control"
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating  col-lg-4">
                                <input type="text" value="{{ $cliente->estado_civil }}"  
                                    class="form-control" name="estado_civil" id="estado_civil"
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating  col-lg-3">
                                <input type="text" value="{{ $cliente->direccion_personal }}"  
                                    class="form-control" placeholder="Direccion cliente" name="direccion_personal"
                                    id="direccion_personal" />
                                <label>Direccion Personal:</label>
                            </div>
                            <div class="form-floating  col-lg-5">
                                <input type="text" class="form-control" placeholder="Nombre negocio "
                                    name="nombre_negocio" value="{{ $cliente->nombre_negocio }}"  
                                    id="nombre_negocio" />
                                <label>Nombre del negocio:</label>
                            </div>
                            <div class="form-floating  col-lg-4">
                                <input type="text" class="form-control" placeholder="Direccion del negocio"
                                    name="direccion_negocio" value="{{ $cliente->direccion_negocio }}"  
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating  col-lg-9">
                                <input type="text" class="form-control" name="observaciones"
                                    value="{{ $cliente->observaciones }}"   placeholder="Observaciones" />
                                ...
                                <div class="form-group row mb-5">
                                    <div class="form-floating col-lg-6">
                                        <input type="number" step="any" required class="form-control"
                                            value="{{ $solicitud->tasa }}"   placeholder="Monto a solicitar"
                                            id="tasa" name="tasa">
                                        <label>Tasa :</label>
                                    </div>
                                    <div class="form-floating col-lg-6">
                                        <input type="number" readonly required class="form-control" placeholder="Cuota"
                                            value="{{ $solicitud->cuota }}"   id="cuota" name="cuota" />
                                        <label>Cuota :</label>
                                    </div>
                                </div>
                                <!--begin::row group-->
                                <div class="form-group row mb-5">
                                    <div class="form-floating col-lg-6">
                                        <input type="number" step="any" name="seguro_deuda" id="seguro_deuda"
                                            value="{{ $solicitud->seguro_deuda }}"   class="form-control"
                                    ...
                                    <div class="form-floating col-lg-6">
                                        <input type="number" name="aportaciones" id="aportaciones" class="form-control"
                                            value="{{ $solicitud->aportaciones }}"   placeholder="Aportaciones">
                                    ...
                                    <div class="form-floating col-lg-12">
                                        <select name="tipo_garantia" id="tipo_garantia" class="form-select"
                                            ...
                                            @foreach ($tiposGarantia as $tipogarantia)
                                                @if ($tipogarantia->id_tipo_garantia == $solicitud->tipo_garantia)
                                                    <option selected value="{{ $tipogarantia->id_tipo_garantia }}">
                                                        {{ $tipogarantia->descripcion }}</option>
                                                @else
                    ...
                    <div class="tab-pane fade show" id="tabConyugue" role="tabpanel">
                            ...
                            <div class="form-floating col-lg-12">
                                <select name="id_conyugue" id="id_conyugue" class="form-select" data-control="select2">
                                    ...
                                    @foreach ($referencias as $referencia)
                                        @if ($referencia->id_referencia == $solicitud->id_conyugue)
                                            <option selected value="{{ $referencia->id_referencia }}">
                                                {{ $referencia->nombre }}
                                                ->{{ $referencia->dui }}
                        ...
                        <div class="form-group row mb-5">
                            <div class="form-floating col-lg-8">
                                <input type="text" name="empresa_labora" value="{{ $solicitud->empresa_labora }}"
                                    class="form-control" placeholder="Nombre conyugue" />
                                <label>Empresa Labora:</label>
                            </div>

                            <div class="form-floating col-lg-4">
                                <input type="text" name="cargo" value="{{ $solicitud->cargo }}"
                                    class="form-control" placeholder="Ingresos conyugue" />
                                <label>Cargo :</label>
                            </div>
                        </div>
                        <!--begin::row group-->
                        <div class="form-group row mb-5">
                            <div class="form-floating col-lg-4">
                                <input type="number" step="any" name="sueldo_conyugue"
                                    value="{{ $solicitud->sueldo_conyugue }}" class="form-control"
                                    placeholder="Ingresos conyugue" />
                                <label>Sueldo :</label>
                            </div>
                            <div class="form-floating col-lg-4">
                                <input type="text" name="tiempo_laborando" value="{{ $solicitud->sueldo_conyugue }}"
                                    class="form-control" placeholder="Tiempo conyugue" />
                                <label>Tiempo Laborando :</label>

                            </div>
                            <div class="form-floating col-lg-4">
                                <input type="text" name="telefono_trabajo" value="{{ $solicitud->telefono_trabajo }}"
                                    class="form-control" placeholder="Telefono Trabajo" />
                    ...
                    <div class="tab-pane fade" id="tabIngresos" role="tabpanel">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row mb-5">
                                    <div class="form-floating">
                                        <input type="number" placeholder="Sueldo"
                                            value="{{ $solicitud->sueldo_solicitante }}" id="sueldo_solicitante"
                                            class="form-control col-lg-12 mb-5" name="sueldo_solicitante">
                                        <label>Sueldo</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="number" placeholder="Comisiones"
                                            value="{{ $solicitud->comisiones }}" class="form-control  mb-5"
                                            name="comisiones" id="comisiones">
                                        <label>Comisiones</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="number"placeholder="Negocio Propio"
                                            value="{{ $solicitud->negocio_propio }}" class="form-control  mb-5"
                                            name="negocio_propio" id="negocio_propio">
                                        <label>Negocio Propio</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="number" placeholder="Otros ingresos"
                                            value="{{ $solicitud->otros_ingresos }}" class="form-control  mb-5"
                                            name="otros_ingresos" id="otros_ingresos">
                                        <label>Otros Ingresos</label>
                                    </div>
                                    <hr>
                                    <div class="form-floating">
                                        <input type="number" placeholder="Total Ingresos"
                                            value="{{ $solicitud->total_ingresos }}" class="form-control  mb-5"
                            ...
                            <div class="col-lg-6 border-active-danger"
                                ...
                                <div class="form-group row mb-5">
                                    <div class="form-floating">
                                        <input type="number" class="form-control col-lg-12 mb-5"
                                            value="{{ $solicitud->gastos_vida }}" name="gastos_vida" id="gastos_vida"
                                            placeholder="gastos de Vida">
                                        <label>Gastos Para Vivir</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="number" class="form-control  mb-5"
                                            placeholder="Pagos y obligaciones"
                                            value="{{ $solicitud->pagos_obligaciones }}" name="pagos_obligaciones"
                                            id="pagos_obligaciones">
                                        <label>Pagos Obligaciones</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="number" class="form-control  mb-5"
                                            value="{{ $solicitud->gastos_negocios }}" placeholder="Gastos del Negocio"
                                            name="gastos_negocios" id="gastos_negocios">
                                        <label>Gastos Negocios</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="number" class="form-control  mb-5"
                                            value="{{ $solicitud->otros_gastos }}" name="otros_gastos" id="otros_gastos"
                                    ...
                                    <div class="form-floating">
                                        <input type="number" class="form-control  mb-5"
                                            value="{{ $solicitud->total_gasto }}" name="total_gasto" id="total_gasto"
