            ...
            <div class="card-header ribbon ribbon-end ribbon-clip">
                <div class="card-toolbar">
                    ...
                    <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#tabCredito">
                ...
                <div class="ribbon-label fs-3">
                    <i class="ki-duotone ki-book text-white fs-3x"><span class="path1"></span><span
                            class="path2"></span><span class="path3"></span></i> &nbsp;
                    Crédito | Enviar a Comite
            ...
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show" id="tabCredito" role="tabpanel">
                        <div class="row">
                            <div class="col-md-6 p-5 px-5" style="border: 1px solid red; border-radius:5px">
                                <div class="row mb-5">
