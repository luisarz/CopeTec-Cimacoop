@extends('base.base')
@section('formName')
    <span class="badge badge-info fs-5">Solicitud: <span class="badge badge-danger">{{ $solicitud->id_solicitud }}</span></span>
@endsection
@section('content')
                    ...
                    <div class="tab-pane fade show active" id="tabSolicitante" role="tabpanel">
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating col-lg-2">
                                <input type="date" value="{{ $solicitud->fecha_solicitud }}"  required readonline
                            ...
                            <div class="form-floating col-lg-10">
                                <select name="id_cliente" id="id_cliente" class="form-select" data-control="select2"
                                    ...
                                    @foreach ($clientes as $cliente)
                                        ...
                                        <option value="{{ $cliente->id_cliente }}" {{$cliente->id_cliente == $solicitud->id_cliente?"selected":""}}>{{ $cliente->nombre }} ->
                        ...
                        <div class="form-group row mb-5">
                            <div class="form-floating  col-lg-2">
                                <input readonline type="date" value="{{$cliente->fecha_nacimiento}}" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento"
                            ...
                            <div class="form-floating  col-lg-3">
                                <input type="text" value="{{$cliente->dui_cliente}}" required class="form-control" placeholder="Dui Cliente"
                                    name="dui_cliente" id="dui_cliente" readonline />
                                <label>Dui:</label>
                            </div>

                            <div class="form-floating  col-lg-4">
                                <input type="date"  value="{{$cliente->fecha_expedicion}}" class="form-control" name="fecha_expedicion"
                                    id="fecha_expedicion" readonline />
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating  col-lg-3">
                                <input type="text" value="{{$cliente->telefono}}" readonline class="form-control" name="telefono" placeholder="telefono"
                                    id="telefono" aria-label="dui" aria-describedby="basic-addon1" />
                                <label>Telefono:</label>
                            </div>
                            <div class="form-floating  col-lg-5">
                                <input type="text" value="{{$cliente->nacionalidad}}" readonline class="form-control" name="nacionalidad" id="nacionalidad"
                                    placeholder="Nacionalidad del cliente" aria-label="nacionalidad"
                                    aria-describedby="basic-addon1" />
                                <label>Nacionalidad:</label>
                            </div>
                            <div class="form-floating  col-lg-4">
                                <input type="text" value="{{$cliente->estado_civil}}" readonline class="form-control" name="estado_civil" id="estado_civil"
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating  col-lg-3">
                                <input type="text" value="{{$cliente->direccion_personal}}" readonline  class="form-control" placeholder="Direccion cliente"
                            ...
                            <div class="form-floating  col-lg-5">
                                <input type="text" class="form-control" placeholder="Nombre negocio "
                                    name="nombre_negocio" value="{{$cliente->nombre_negocio}}" readonline id="nombre_negocio" />
                                <label>Nombre del negocio:</label>
                            </div>
                            <div class="form-floating  col-lg-4">
                                <input type="text" class="form-control" placeholder="Direccion del negocio"
                                    name="direccion_negocio"  value="{{$cliente->direccion_negocio}}" readonline id="direccion_negocio" />
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="form-floating  col-lg-9">
                                ...
                                value="{{$cliente->observaciones}}" readonline placeholder="Observaciones" />
                            ...
                            <div class="col-md-6 p-5" style="border: 1px solid red; border-radius:5px">
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="form-floating col-lg-6">
                                        ...
                                        value="{{$solicitud->monto_solicitado}}" readonline
                                            id="monto_solicitado" class="form-control" placeholder="numero_cheque" />
                                        <label>Monto Solicitado:</label>
                                    </div>
                                    <div class="form-floating col-lg-6">
                                        <input type="number" step="any" name="plazo" id="plazo"
                                        value="{{$solicitud->plazo}}" readonline class="form-control" placeholder="numero_cheque" />
                                        <label>Plazo </label>
                                    </div>
                                </div>
                                <!--begin::row group-->
                                <div class="form-group row mb-5">
                                    <div class="form-floating col-lg-6">
                                        ...
                                        value="{{$solicitud->tasa}}" readonline  placeholder="Monto a solicitar" id="tasa" name="tasa">
                                        <label>Tasa :</label>
                                    </div>
                                    <div class="form-floating col-lg-6">
                                ...
                                <div class="form-group row mb-5">
                                    <div class="form-floating col-lg-6">
                                        ...
                                        value="{{$solicitud->seguro_deuda}}" readonline class="form-control" placeholder="Seguro de deuda" />
                                ...
                                <div class="form-group row mb-5">
                                    ...
                                    <div class="form-floating col-lg-12">
                                        ...
                                        readonline data-kt-autosize="true">{{$solicitud->garantia}}</textarea>
