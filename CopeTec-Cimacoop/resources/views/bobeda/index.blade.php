            ...
            <div class="d-flex flex-wrap flex-sm-nowrap">
                ...
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-100px symbol-fixed position-relative">
                        <button class="btn btn-danger">Enviar <br>a caja</button>
                        <div class="position-absolute translate-middle bottom-0 start-10 mb-6 bg-danger rounded-circle border border-4 border-body h-20px w-20px">
                        </div>
                        <button class="btn btn-success">Recibir <br>de caja</button>
