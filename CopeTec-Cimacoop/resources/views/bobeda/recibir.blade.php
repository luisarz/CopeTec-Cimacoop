...
@endsection
@section('content')
    <form action="/bobeda/recibirTraslado" method="post" autocomplete="nope">
        {!! csrf_field() !!}
        {{ method_field('POST') }}
        ...
        <div class="card-body">
            ...
            <div class="form-group row mb-5">
                ...
                <div class="form-floating col-1">
                    ...
                    <button type="submit" class="btn btn-bg-success btn-text-white">Recibir</button>
                </div>
