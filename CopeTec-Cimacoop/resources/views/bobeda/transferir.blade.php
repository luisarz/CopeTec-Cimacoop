...
@endsection
@section('content')
    <form action="/bobeda/realizarTraslado" id="traslado" method="post" target='_blank' autocomplete="nope">
        {!! csrf_field() !!}
        {{ method_field('POST') }}
        ...
        <div class="card-body">
            ...
            <div class="form-group row mb-5">
                ...
                <div class=" form-floating col-lg-3">
                    <input type="number" required class="form-control input-group-lg" name="monto" placeholder="monto"
