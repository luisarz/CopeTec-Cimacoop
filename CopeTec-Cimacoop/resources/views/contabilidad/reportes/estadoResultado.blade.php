...
@section('content')
    <form action="/contabilidad/Reporte/estadoresultado" method="post" autocomplete="off" target="_blank" >
        {!! csrf_field() !!}
        {{ method_field('POST') }}
    <div class="card shadow-lg mt-3">
        ...
        <!--begin::Body-->
        <div class="card-body">
            <h3>Complete los siguientes parametros del Estado de Resultado</h3>
            <hr>
