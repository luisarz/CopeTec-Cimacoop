...
@section('content')
    <div class="card shadow-lg">
        <div class="card-header ribbon ribbon-end ribbon-clip">
            <div class="card-toolbar">
                <a href="/contabilidad/tipocuentacontable/add" class="btn btn-info"><i class="fa-solid fa-plus"></i> Agregar
                    Tipo Cuenta</a>
                    ...
                    @foreach ($tipoCuentas as $tipoCuenta)
                        <tr>
                            <td>
                                ...
                                <a href="/contabilidad/tipocuentacontable/edit/{{ $tipoCuenta->id_tipo_catalogo }}"
                                    class="btn btn-sm btn-info"><i class="fa-solid fa-pencil text-white"></i>
                                </a>

                                <a href="javascript:void(0);" onclick="alertDelete({{ $tipoCuenta->id_tipo_catalogo }})"
    ...
    <form method="post" id="deleteForm" action="/contabilidad/tipocuentacontable/delete">
        {!! csrf_field() !!}
        {{ method_field('DELETE') }}
