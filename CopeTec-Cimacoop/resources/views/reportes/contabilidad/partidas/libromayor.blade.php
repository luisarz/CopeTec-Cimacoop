                            ...
                            @foreach ($s['movimientos'] as $mov => $m)
                                @if (array_key_exists('fecha_dia', $m))
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td> {{ $m['total_cargos'] }} <?php $cargos += $m['total_cargos']; ?></td>
                                        <td> {{ $m['total_abonos'] }}<?php $abonos += $m['total_abonos']; ?></td>
                                        <td> {{ $m['fecha_dia'] }}</td>
                                    </tr>
                                @endif
                            @endforeach
                                    ...
                                    @foreach ($s2['movimientos'] as $mov2 => $m2)
                                        @if (array_key_exists('fecha_dia', $m2))
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td> {{ $m2['total_cargos'] }} <?php $cargos += $m2['total_cargos']; ?></td>
                                                <td> {{ $m2['total_abonos'] }} <?php $abonos += $m2['total_abonos']; ?></td>
                                                <td> {{ $m2['fecha_dia'] }}</td>
                                            </tr>
                                        @endif
                                    @endforeach
                                            ...
                                            @foreach ($s3['movimientos'] as $mov3 => $m3)
                                                @if (array_key_exists('fecha_dia', $m3))
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td> {{ $m3['total_cargos'] }}<?php $cargos += $m3['total_cargos']; ?></td>
                                                        <td> {{ $m3['total_abonos'] }}<?php $abonos += $m3['total_abonos']; ?></td>
                                                        <td> {{ $m3['fecha_dia'] }}</td>
                                                    </tr>
                                                @endif
                                            @endforeach
                                                    ...
                                                    @foreach ($s4['movimientos'] as $mov4 => $m4)
                                                        @if (array_key_exists('fecha_dia', $m4))
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td></td>
                                                                <td> {{ $m4['total_cargos'] }}<?php $cargos += $m4['total_cargos']; ?></td>
                                                                <td> {{ $m4['total_abonos'] }}<?php $abonos += $m4['total_abonos']; ?></td>
                                                                <td> {{ $m4['fecha_dia'] }}</td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
