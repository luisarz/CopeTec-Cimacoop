    ...
    <div class="container">
        <div class="alinea">
            ...
            <div class="item" style="width: 20%; height:10%">
                <div class="price"> {{ $movimientos[0]->tipo_cuenta }}</div>
                <div class="description">Tipo Cuenta</div>
            </div>
             <div class="item" style="width: 12%; height:8%">
                <div class="price">  {{ str_pad($movimientos[0]->numero_cuenta, 10, '0', STR_PAD_LEFT) }}</div>
                <div class="description">Numero</div>
            </div>
            <div class="item" style="width: 45%; height:10%">
                <div class="price"> <span class="badge badge-danger fs-6">
                       </span>
                    {{ $clienteData->nombre }}</div>
                <div class="description">Titular Cuenta</div>
            </div>
             <div class="item" style="width: 10%; height:10%">
                <div class="price">$ {{ number_format($movimientos[0]->saldo_cuenta, 2, '.', ',') }}</div>
    ...
    <table class="table table-responsive">
        <thead class="thead">
            <tr class="fw-semibold fs-3 text-gray-800 border-bottom-2 border-gray-200">
                ...
                <th class="min-w-100px">Realizo Operacion</th>
