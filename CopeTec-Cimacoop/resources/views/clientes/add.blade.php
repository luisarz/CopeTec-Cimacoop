            ...
            <div class="card-body">
                ...
                <div class="form-group row mb-5">
                    <div class="form-floating  col-lg-5">
                        <input type="text" required value="{{ old('nombre') }}" class="form-control" name="nombre"
                    ...
                    <div class="form-floating  col-lg-4">
                        <input type="date" required max="{{ date('Y-m-d') }}" value="{{ old('fecha_nacimiento') }}"
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="form-floating  col-lg-3">
                        <input type="text" required value="{{ old('dui_cliente') }}" class="form-control"
                            name="dui_cliente" placeholder="dui_cliente" aria-label="dui" aria-describedby="basic-addon1" />
                        <label>Dui:</label>
                    </div>
                    <div class="form-floating  col-lg-5">
                        <input type="text"required value="{{ old('dui_extendido') }}" class="form-control"
                            name="dui_extendido" placeholder="Extendido en" aria-label="dui_extendido"
                            aria-describedby="basic-addon1" />
                        <label>Dui extendido en:</label>
                    </div>
                    <div class="form-floating col-lg-4">
                        <input type="date" required max="{{ date('Y-m-d') }}" value="{{ old('fecha_expedicion') }}"
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="form-floating col-lg-3">
                        <input type="text" required value="{{ old('telefono') }}" class="form-control" name="telefono"
                            placeholder="telefono" aria-label="dui" aria-describedby="basic-addon1" />
                        <label>Telefono:</label>
                    </div>
                    <div class="form-floating  col-lg-5">
                        <input type="text" required value="{{ old('nacionalidad') }}" class="form-control"
                            name="nacionalidad" placeholder="Nacionalidad del cliente" aria-label="nacionalidad"
                            aria-describedby="basic-addon1" />
                        <label>Nacionalidad:</label>
                    </div>
                    <div class="form-floating  col-lg-4">
                        <input type="text" required value="{{ old('estado_civil') }}" class="form-control"
                ...
                <div class="form-group row mb-5">
                    ...
                    <div class="form-floating col-lg-9">
                        <input type="text" value="{{ old('observaciones') }}" class="form-control"
