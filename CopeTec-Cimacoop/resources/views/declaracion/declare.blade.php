...
@section('content')
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            ...
            @endif
            <div id="GFG">
                <form method="POST" action="{{ $dec->declaracion_id==null ? url('declare/add'):url('declare/update') }}">
                    <div class="container">
                        {!! csrf_field() !!}
                        {{ method_field('POST') }}
                        ...
                        <input type="hidden" name="id_cliente" id="id_cliente"
                            ...
                            <input type="hidden" name="declaracion_id" id="declaracion_id"
                            value="{{ $dec->declaracion_id }}">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select name="depo_tipo" id="depo_tipo"
                                        ...
                                        <option value="Efectivo" {{ $dec->depo_tipo == 'Efectivo' ? 'selected' : '' }}>
                                            Efectivo
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select name="ret_tipo" id="ret_tipo"
                                        ...
                                        <option value="Efectivo" {{ $dec->ret_tipo == 'Efectivo' ? 'selected' : '' }}>
                                            Efectivo
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-6">
                                <select name="origen_fondos" id="origen_fondos"
                                    class="form-control custom-select custom-select-lg mb-3">
                                    <option value="Salarios" {{ $dec->origen_fondos == 'Salarios' ? 'selected' : '' }}>
                                        Salarios
                                    </option>
                                    <option value="Negocio Propio"
                                        {{ $dec->origen_fondos == 'Negocio Propio' ? 'selected' : '' }}>Negocio
                                        Propio</option>
                                    <option value="Pensión" {{ $dec->origen_fondos == 'Pensión' ? 'selected' : '' }}>
                                        Pensión
                                    </option>
                                    <option value="Remesas" {{ $dec->origen_fondos == 'Remesas' ? 'selected' : '' }}>
                                        Remesas
                                    </option>
                                    <option value="Dividendos"
                                        {{ $dec->origen_fondos == 'Dividendos' ? 'selected' : '' }}>
                                        Dividendos
                                    </option>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <input type="text" name="otro_origen_fondos"
                                        value="{{ $dec->otro_origen_fondos }}" class="form-control"
                            ...
                            <div class="col-6">
                                <select name="comprobante_procedencia_fondo" id="comprobante_procedencia_fondo"
                                    ...
                                    <option value="Constancia de Salarios"
                                        {{ $dec->origen_fondos == 'Constancia de Salarios' ? 'selected' : '' }}>Constancia
                                        de
                                        Salarios
                                    </option>
                                    ...
                                    <option value="Carné o constancia de pensión"
                                        {{ $dec->origen_fondos == 'Carné o constancia de pensión' ? 'selected' : '' }}>
                                        Carné o
                                        constancia de pensión
                                    </option>
                                    <option value="Últimas tres remesas recibidas"
                                        {{ $dec->origen_fondos == 'Últimas tres remesas recibidas' ? 'selected' : '' }}>
                                        Últimas
                                        tres remesas
                                        recibidas</option>
                                    ...
                                    <option value="Declaratoria de heredero"
                                        {{ $dec->origen_fondos == 'Declaratoria de heredero' ? 'selected' : '' }}>
                                        Declaratoria
                                        de heredero
                                    </option>
                                    <option value="Otros" {{ $dec->origen_fondos == 'Otros' ? 'selected' : '' }}>Otros
