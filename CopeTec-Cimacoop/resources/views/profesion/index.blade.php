    ...
    <div class="card shadow-lg">
        <div class="card-header ribbon ribbon-end ribbon-clip">
            <div class="card-toolbar">
                <a href="/profesiones/add" class="btn btn-info"><i class="fa-solid fa-plus"></i> Agregar profesion</a>
            ...
            <table class="data-table-coop table table-hover table-row-dashed fs-6     gy-2 gs-5">
                ...
                <tbody>
                    @foreach ($profesiones as $profesion)
                        <tr>
                            <td>
                                <a href="javascript:void(0);" onclick="alertDelete({{ $profesion->id }})"
                                    class="btn btn-sm btn-danger"><i class="fa-solid fa-trash text-white"></i>
                                    </a>
                                    <a href="/profesiones/{{ $profesion->id }}" class="btn btn-sm btn-info"><i
        ...
        <div class="card-footer">
            {{ $profesiones->links('vendor.pagination.bootstrap-5') }}
        </div>
    </div>
